...
public class BrowserUtils {
    ...
    public static void selectBy(WebElement location,String value,String methodName){
        ...
        switch (methodName){
            ...
            case "value":
                ...
                break;
            case "index":
                select.selectByIndex(Integer.parseInt(value));//by index normally passing Integer into as pm,
                // then we did ParseInt. bcs gotta be String checks12
                break;
            default:
    ...
    public static void getScreenShot(WebDriver driver,String packageName){//this is for TestNG
